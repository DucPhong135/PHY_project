...
#(
  ...
  parameter int MAX_DATA_THRESHOLD = 64, 
  parameter int MAX_HDR_THRESHOLD  = 1
)(
  input  logic             clk,
  input  logic             rst_n,
