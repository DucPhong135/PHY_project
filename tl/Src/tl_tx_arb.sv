    ...
    if(fsm_state == HDR && tl_tx_ready_i) begin
      case(grant_state)
        GRANT_P: begin
          ...
          if(tl_hdr_o.data[6] == 1'b1) begin
            pd_consume_v_o  <= 1'b1;
            pd_consume_dw_o <= ({tl_hdr_o.data[17:16], tl_hdr_o.data[31:24]} + 3) >> 2;
          end
          else begin
            pd_consume_v_o  <= 1'b0;
            pd_consume_dw_o <= '0;
        ...
        GRANT_NP: begin
          ...
          if(tl_hdr_o.data[6] == 1'b1) begin
            ...
            npd_consume_dw_o <= ({tl_hdr_o.data[17:16], tl_hdr_o.data[31:24]} + 3) >> 2;
          end
          else begin
            npd_consume_v_o  <= 1'b0;
            npd_consume_dw_o <= '0;
        ...
        GRANT_CPL: begin
          ...
          if(tl_hdr_o.data[6] == 1'b1) begin
            ...
            cpld_consume_dw_o<= ({tl_hdr_o.data[17:16], tl_hdr_o.data[31:24]} + 3) >> 2;
          end
          else begin
            cpld_consume_v_o <= 1'b0;
            cpld_consume_dw_o<= '0;
